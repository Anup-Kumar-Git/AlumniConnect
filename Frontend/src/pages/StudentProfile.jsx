...
import { User, Mail, Phone, Book, Briefcase, FileText, Camera, Edit2, Check, X } from 'lucide-react';
...
const StudentProfile = ({ isDark }) => {
  ...
  const defaultAvatar = `https://ui-avatars.com/api/?name=${profile.name || 'User'}&background=5c4dff&color=fff`;

  if (loading && !profile.email) {
    return (
      <DashboardLayout isDark={isDark} role="Student" userName={profile.name || 'Student'}>
          ...
          <div className="p-8 sm:p-12 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <ProfileField
                ...
                value={isEditing ? editForm.interestedSubject : profile.interestedSubject}
                isEditing={isEditing}
                onChange={handleEditChange}
                isDark={isDark}
              ...
              <ProfileField
                ...
                name="domain"
                value={isEditing ? editForm.domain : profile.domain}
                isEditing={isEditing}
                onChange={handleEditChange}
                isDark={isDark}
              ...
              <div className="md:col-span-2">
                <ProfileField
                  ...
                  isDark={isDark}
                  isTextArea={true}
                  placeholder="Share a brief bio or any other details..."
                />
              </div>
